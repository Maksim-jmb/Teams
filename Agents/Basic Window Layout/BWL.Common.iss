...
objectdef bwlHorizontalLayout
{
    ...
    method ApplyWindowLayout(bool setOtherSlots=TRUE)
    {
        ...
        variable uint numSmallRegions=${ULSfix3}
        ...
        for (numSlot:Set[1] ; ${numSlot}<=${ULSfix3} ; numSlot:Inc)
        {
...
objectdef bwlCustomRRWindowLayout
{
    ...
    method ApplyWindowLayout(bool setOtherSlots=TRUE)
    {
        ...
        relay jmb${ULSfix2} "WindowCharacteristics -visibility bottom -pos -viewable 2560,0 -size -viewable 100x100 -frame none "
    }
}
...
objectdef bwlVfx4WindowLayout
{
    ...
    method ApplyWindowLayout(bool setOtherSlots=TRUE)
    {
        ...
        if ${ULSfix3}<=4
            relay jmb${ULSfix2} "WindowCharacteristics -pos -viewable 2560,0 -size -viewable 640x1080 -frame none "
            relay ~jmb${ULSfix2} "WindowCharacteristics -pos -viewable ${mainX},${mainY} -size -viewable ${mainWidth}x${mainHeight} -frame none"
            relay ~jmb${ULSfix2} "LGUI2.Element["vfx4.window"]:Destroy"
        if ${ULSfix3}>=5 && ${ULSfix3}<=8
            relay jmb${ULSfix2} "WindowCharacteristics -pos -viewable 2560,0 -size -viewable 1280x1080 -frame none "
            relay ~jmb${ULSfix2} "WindowCharacteristics -pos -viewable ${mainX},${mainY} -size -viewable ${mainWidth}x${mainHeight} -frame none"
            relay ~jmb${ULSfix2} "LGUI2.Element["vfx4.window"]:Destroy"
        if ${ULSfix3}>=9
...
objectdef bwlVfx5WindowLayout
{
    ...
    method ApplyWindowLayout(bool setOtherSlots=TRUE)
    {
        ...
        if ${ULSfix3}<=5
            relay jmb${ULSfix2} "WindowCharacteristics -pos -viewable 2560,0 -size -viewable 1920x270 -frame none "
            relay ~jmb${ULSfix2} "WindowCharacteristics -pos -viewable ${mainX},${mainY} -size -viewable ${mainWidth}x${mainHeight} -frame none "
            relay ~jmb${ULSfix2} "LGUI2.Element["vfx5.window"]:Destroy"
        if ${ULSfix3}>=6 && ${ULSfix3}<=10
            relay jmb${ULSfix2} "WindowCharacteristics -pos -viewable 2560,0 -size -viewable 1920x540 -frame none "
            relay ~jmb${ULSfix2} "WindowCharacteristics -pos -viewable ${mainX},${mainY} -size -viewable ${mainWidth}x${mainHeight} -frame none "
            relay ~jmb${ULSfix2} "LGUI2.Element["vfx5.window"]:Destroy"
        if ${ULSfix3}>=11 && ${ULSfix3}<=15
            relay jmb${ULSfix2} "WindowCharacteristics -pos -viewable 2560,0 -size -viewable 1920x810 -frame none "
            relay ~jmb${ULSfix2} "WindowCharacteristics -pos -viewable ${mainX},${mainY} -size -viewable ${mainWidth}x${mainHeight} -frame none "
            relay ~jmb${ULSfix2} "LGUI2.Element["vfx5.window"]:Destroy"
        if ${ULSfix3}>=16
            relay jmb${ULSfix2} "WindowCharacteristics -pos -viewable 2560,0 -size -viewable 1920x1080 -frame none "
